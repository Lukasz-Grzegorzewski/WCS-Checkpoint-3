...
const findByName = (name) => {
  return db.query(
    `SELECT b.id, b.name AS name, b.coord_x AS coord_x, b.coord_y AS coord_y, t.type, t.has_treasure AS has_treasure FROM ${table} b INNER JOIN tile t ON b.coord_x = t.coord_x AND b.coord_y = t.coord_y WHERE name = ?;`,
    [name]
  );
};
